...
public class Test {
	...
	public static void main(String[] args) {
		...
		float a = (2*productsList.get(1).getPrice()) + (2*productsList.get(1).getPrice());
		...
		System.out.println((l-k)/100f);
		
//		int c = (int)(b*100-a*100);
//		
//		System.out.println(c);
	...
	public static void showProductsList() {
		...
		for (int i = 1; i <= productsList.size(); i++) {
			...
			System.out.printf("%2d | %s%s | $ %f | %2d pcs%n", productsList.get(i).getId(), productsList.get(i).getName(),
